...
class RulesTest(unittest.TestCase):
    ...
    def test_action_calculation(self):
        ...
        self.assertEqual(payload["planned_start"], "2026-01-10T00:00:00+00:00")
        self.assertEqual(payload["spare_reserved_km"], 15.75)
        plan = self.rules.resource_plan(record, action, payload)
        self.assertEqual(plan["ops"], [{"op": "reserve", "vessel": "CS-1", "amount_km": 15.75}])
        self.assertEqual(plan["schedule"]["vessel"], "CS-1")
